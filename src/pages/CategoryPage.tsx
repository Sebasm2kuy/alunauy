...
const CategoryPage: React.FC<CategoryPageProps> = ({ category, title, description }) => {
  ...
  const allProducts: Product[] = [
    ...
    },
    {
      ...
      description: "Labial con ingredientes naturales y colores vibrantes",
      rating: 4.6,
      reviews: 78,
      badge: "NATURAL"
    },
    ...
    {
      id: 12,
      name: "Kit de Accesorios de Belleza",
      category: "otros",
      price: "$35.99",
      originalPrice: "$50.00",
      image: "https://images.pexels.com/photos/3373736/pexels-photo-3373736.jpeg?auto=compress&cs=tinysrgb&w=400",
      description: "Kit completo con esponjas, pinceles y herramientas de aplicación",
      rating: 4.5,
      reviews: 92,
      badge: "KIT"
    }
