        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li><button onClick={() => onPageChange('products')} className="hover:text-white transition-colors">Cuidado Facial</button></li>
              <li><button onClick={() => onPageChange('products')} className="hover:text-white transition-colors">Cuidado Corporal</button></li>
              <li><button onClick={() => onPageChange('products')} className="hover:text-white transition-colors">Maquillaje</button></li>
              <li><button onClick={() => onPageChange('products')} className="hover:text-white transition-colors">Accesorios</button></li>
            </ul>
          </div>
